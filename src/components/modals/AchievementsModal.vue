    ...
    <div v-if="isOpen" class="fixed inset-0 w-full h-full bg-black/70 flex justify-center items-center z-[1000]"
        ...
        <div
            ...
            <div class="text-center my-4">
                <h2 class="text-3xl font-extrabold m-0 text-primary uppercase tracking-wide drop-shadow-md">Mes Succès
                </h2>
            </div>
            <p class="text-center text-xl mb-6 font-bold text-primary">{{ unlockedCount }} / {{ totalCount }}</p>
