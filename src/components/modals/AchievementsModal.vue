        ...
        <div
            ...
            <div class="p-8 pb-4 shrink-0">
                ...
                <div class="text-center my-4">
                    <h2 class="text-3xl font-extrabold m-0 text-primary uppercase tracking-wide drop-shadow-md">Mes
                        Succès
                    </h2>
                </div>
                <p class="text-center text-xl mb-2 font-bold text-primary">{{ unlockedCount }} / {{ totalCount }}</p>
            </div>
